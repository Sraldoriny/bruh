...
html {
	background: #ccc;
	font: bold 14px/20px "Bitter", "Times New Roman", Times, serif;
	color: #430400;
...
.error-page {
	...
	filter: progid:DXImageTransform.Microsoft.gradient(startColorstr="#d36242", endColorstr="#d36242",GradientType=0 );
}
.error-page:before {
	width: 63px;
	height: 63px;
